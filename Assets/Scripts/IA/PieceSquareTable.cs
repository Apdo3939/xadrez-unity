...
public class PieceSquareTable
{
    ...
    public Dictionary<Vector2Int, int> rockGold = new Dictionary<Vector2Int, int>();
    public Dictionary<Vector2Int, int> rockGreen = new Dictionary<Vector2Int, int>();
    ...
    public void SetDictionaries()
    {
        ...
        List<int> rockValues = new List<int>(){
            0,  0,  0,  0,  0,  0,  0,  0,
        ...
        SetDictionary(rockGold, rockGreen, rockValues);
